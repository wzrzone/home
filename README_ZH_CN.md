...
我们只是英语天天练一位地图创作者，与英语天天练官方没有任何的从属关系。
...
1. 从 ` main ` 创建一个名字叫 ` readme-edits ` + <_你的用户名_> 的分支。
2. 在**你创建的分支**中的 ` README.md ` 中编辑。
3. 编辑后发起拉取请求（pull request）。
4. 等待我的审批，同时请留意发件人为 ` wzrzone@outlook.com ` 的邮件，长期未收到邮件可视为未采纳你的更改。
